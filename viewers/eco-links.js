 ...
 *   el.innerHTML = RecursiveEcoLinks.barHTML(slug, { type:'iching', item:22 });
 */
(function () {
  ...
  (function injectCSS() {
    ...
    s.textContent =
      ...
      '.eco-cast{background:linear-gradient(135deg,#7a2d20,#9c3b2a);color:#fff;box-shadow:0 3px 14px rgba(156,59,42,.35)}' +
      '.eco-view{background:transparent;color:#b9a3f5;border-color:rgba(156,59,42,.45)}' +
      '.eco-edit{background:transparent;color:#9ad0b5;border-color:rgba(129,178,154,.45)}' +
      '.eco-btn:hover{filter:brightness(1.12)}' +
      '.eco-view:hover{background:rgba(156,59,42,.12)} .eco-edit:hover{background:rgba(129,178,154,.10)}';
